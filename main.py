...
def fill_gradient(surface, color, gradient, rect, forward):
    if rect is None:
...
fill_gradient(screen, RED, (28, 170, 156), left_side(), forward=True)
fill_gradient(screen, RED, (28, 170, 156), right_side(), forward=False)
        ...
        if record_button.draw():
            ...
            if not game_over:
                if not keyword == 'stop' or 'go':
                    ...
                    if player == 2:
                        fill_gradient(screen, GREEN, (28, 170, 156), left_side(), forward=True)
                        fill_gradient(screen, GREEN, (28, 170, 156), right_side(), forward=False)
                    else:
                        fill_gradient(screen, RED, (28, 170, 156), left_side(), forward=True)
                        fill_gradient(screen, RED, (28, 170, 156), right_side(), forward=False)
